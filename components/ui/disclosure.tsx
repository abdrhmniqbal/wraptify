...
const disclosure = tv({
  base: ['peer group/disclosure border-border w-full min-w-60 border-b'],
  variants: {
    isDisabled: {
...
const disclosureTrigger = tv({
  base: [
    'group/trigger **:data-[slot=icon]:text-muted-fg flex w-full items-center justify-between gap-x-2 py-3 text-left font-medium **:data-[slot=chevron]:size-5 **:data-[slot=icon]:-mx-0.5 **:data-[slot=icon]:shrink-0 **:[span]:flex **:[span]:items-center **:[span]:gap-x-1 **:[span]:*:data-[slot=icon]:mr-1 [&[aria-expanded=true]_[data-slot=chevron]]:-rotate-180',
  ],
  variants: {
    isFocused: {
