...
const buttonStyles = tv({
  ...
  variants: {
    intent: {
      ...
      secondary: [
        '[--btn-bg:theme(--color-secondary/95%)] dark:[--btn-bg:theme(--color-secondary/85%)] [--btn-border:theme(--color-secondary-fg/10%)] dark:[--btn-border:theme(--color-secondary-fg/7%)] [--btn-fg:var(--color-secondary-fg)]',
    ...
    appearance: {
      ...
      plain: [
        'data-hovered:bg-secondary data-pressed:bg-secondary border-transparent',
      ],
    },
    size: {
      'extra-small':
